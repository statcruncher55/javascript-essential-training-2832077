...
const addFigure = (dataObj) => {
  ...
  newImg.setAttribute("alt", "Frog Image");
 ...
 * - Returns <article>
 */
const createFigureArticle = (imageFigure) => {
  let newArticle = document.createElement("article");
  newArticle.innerHTML = content;
  newArticle.prepend(addFigure(imageFigure));
  return newArticle;
};

document.querySelector("main").append(createFigureArticle(frogpack));
