...
const everydayPack = new Backpack("Everyday Backpack", 30, "grey", 15, 26, 26, true, "December 5, 2018 15:00:00 PST", "../assets/images/everyday.svg");
...
const content = `
    ...
    <ul class="backpack__features">
      ...
      <li class="feature backpack__lid">Lid status:<span> ${everydayPack.lidOpen ? "open" : "closed"}</span></li>
    </ul>
  `;
...
// testing for condition - terniary operator
everydayPack.lidOpen ? console.log("open") : console.log("closed");
